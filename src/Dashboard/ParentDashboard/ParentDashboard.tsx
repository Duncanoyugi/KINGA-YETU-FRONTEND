    ...
    <div className="min-h-screen bg-gray-50 flex">
      ...
      {!isLayoutOnly && (
        <main className="flex-1 ml-64 p-8">
          ...
          {/* Stats Cards - Updated colors to match second image */}
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
            {/* Immunization Progress - Light Blue */}
            ...
            {/* Missed Vaccinations - Red */}
            <div className="bg-red-400 rounded-2xl p-6 text-white shadow-lg">
              <div className="mb-4">
                <div className="bg-white/20 p-3 rounded-xl w-fit">
          ...
          {/* Quick Actions & Emergency Contacts - Restructured to match second image */}
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-6 mb-8">
            ...
            {/* Emergency Contacts - Updated to match second image */}
            <div className="bg-white rounded-xl border border-gray-200 p-6">
              ...
              <div className="space-y-3">
                <div className="flex items-center gap-3 p-3 bg-red-50 rounded-lg">
                  ...
                  <div>
                    <p className="text-xs text-red-600 font-medium">Hotline 1199</p>
                  </div>
                </div>
          ...
          {/* Upcoming Vaccinations & Recent Activity - Keep existing code */}
          ...
          {/* Health Tips - Keep existing code */}
          <div className="bg-white rounded-xl border border-gray-200 p-6">
            <div className="flex justify-between items-center mb-4">
              <div>
